...
#include "system_BAT32A237.h"                   /*!< BAT32G137 System                                                          */
...
typedef struct {                                /*!< (@ 0x40041D80) TM40 Structure                                             */
	__IM  uint16_t  TCR[4];                        /*!< (@ 0x00000000) Timer count register 00~03                                    */
	__IM  uint16_t  RESERVED[4];
	__IOM uint16_t  TMR[4];                        /*!< (@ 0x00000010) Timer mode register mn                                     */
	__IM  uint16_t  RESERVED1[4];
	__IM  uint16_t  TSR[4];                        /*!< (@ 0x00000020) Timer status register mn                                   */
	...
	__IOM uint16_t TDR[2];                       /*!< (@ 0x0000019A) Timer data register TDR00  TDR01                          */
 
	__IM  uint16_t  RESERVED4[36];

	__IOM uint16_t TDR1[2];                       /*!< (@ 0x000001E4) Timer data register TDR02  TDR03                        */
...
typedef struct {
	...
	__IM  uint16_t  RESERVED9[239];

	__IOM uint16_t SIO: 8;
	__IOM uint16_t	  : 1;
	__IOM uint16_t SDR: 7;
} I2C5_TypeDef,SSPI5_TypeDef;
...
typedef struct {                                /*!< (@ 0x00500668) TSN Structure                                              */
  __IM  int16_t   TSN125;                        /*!< (@ 0x00000000) The A/D conversion value of Temperature Sensor
                                                                    at 125 degrees and 3.0V reference voltage                   */
  __IM  uint16_t  RESERVED;
